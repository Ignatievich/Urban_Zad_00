...
"""
#== Тестирование функции print_params() с параметрами по умолчанию ===
...
#== Тестирование распаковки параметров ================================
values_list = [ True, [ 13, 17, 19 ], 'Гаечный ключ' ]
values_dict = { 'a': 15, 'b': 30, 'c': 45 }
print_params( *values_list )
print_params( **values_dict )

#== Тестирование распаковки с отдельными параметрами ===================
values_list_2 = [ 54.32, 'Строка' ]
print_params( *values_list_2, 42 )   # ПРОВЕРЕНО, РАБОТАЕТ!
